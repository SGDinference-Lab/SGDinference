...
sgdi_lm_new = function(formula, data, gamma_0=1, alpha=0.667, burn=1, inference="rs",
                bt_start = NULL,  
  ...
  #----------------------------------------------
  out = sgdi_lm_cpp_new(x, y, burn, gamma_0, alpha, bt_start=bt_t, inference=inference, rss_idx=rss_idx)
